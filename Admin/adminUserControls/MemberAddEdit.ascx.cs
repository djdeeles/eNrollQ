...
{
    public partial class MemberAddEdit : System.Web.UI.UserControl
    {
        ...
        { 
            try
            {
                ...
                Member.UserGeneral.MarriageDate = dpEditMarriageDate.SelectedDate != null &&
                    dpEditMarriageDate.SelectedDate.Value != null ? dpEditMarriageDate.SelectedDate : null;
                Member.UserGeneral.Birthdate = dpEditBirthDate.SelectedDate != null &&
                    dpEditBirthDate.SelectedDate.Value != null ? dpEditBirthDate.SelectedDate : null;

                if (dpEditLastSchoolGraduateDate.SelectedDate != null)
                    userGeneral.LastSchoolGraduateDate = Convert.ToDateTime("01.01." + dpEditLastSchoolGraduateDate.SelectedDate.Value.Year.ToString());


                Member.UserGeneral.Gender = ddlEditGender.SelectedIndex > 0 ? Convert.ToInt32(ddlEditGender.SelectedItem.Value) : 0;
                Member.UserGeneral.BloodType = ddlEditBloodType.SelectedIndex > 0 ? Convert.ToInt32(ddlEditBloodType.SelectedItem.Value) : 0;
                Member.UserGeneral.MaritalStatus = ddlEditMaritalStatus.SelectedIndex > 0 ? Convert.ToInt32(ddlEditMaritalStatus.SelectedItem.Value) : 0;
                ...
                if (cbMemberDecease.Checked)
                {
                    ...
                    {
                        Member.UserGeneral.DeceaseDate = Convert.ToDateTime(dpMemberDeceaseDate.SelectedDate.Value.ToShortDateString());
                    }
                    else
                    {
        ...
        protected void BtnUpdateMemberInfoClick(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if (dpEditMembershipDate.SelectedDate != null)
                    userFoundation.MembershipDate = Convert.ToDateTime(string.Format("01.01.{0}", dpEditMembershipDate.SelectedDate.Value.Year.ToString()));

                userFoundation.MemberNo = tbEditMembershipNumber.Text;
                userFoundation.MemberRelType = ddlEditMemberRelationType.SelectedIndex > 0 ? Convert.ToInt32(ddlEditMemberRelationType.SelectedItem.Value) : 0;
                userFoundation.SpecialNo = tbEditSpecialNumber.Text;
                userFoundation.Term = dpEditTerm.SelectedDate != null ? dpEditTerm.SelectedDate.Value.Year.ToString() : string.Empty;
            ...
            try
            {
                ...
                if (checkEmailAddress.Count > 0)
                {
                    ...
                    Page.ClientScript.RegisterStartupScript(GetType(),
                        "haveAlreadyEmai2", "<script> showUserInfo('dEmailAddress');alert('" + AdminResource.lbMailAddressTakenAlready + "');</script>");
                    return;
                }
                else
                {
                    if (!string.IsNullOrWhiteSpace(tbNewEmailAddress.Text))
                    {
                        ...
                        BindEmailInfo();
                        Page.ClientScript.RegisterStartupScript(GetType(),
                        "haveAlreadyEmai2", "<script> showUserInfo('dEmailAddress');</script>");
                        /*
                         *  
        ...
        public void BindPersonalInfo()
        {
            ...
            try
            {
                ...
                if (Member.UserGeneral != null)
                {
                    ...
                    lUserPhoto.ImageUrl = !string.IsNullOrWhiteSpace(Member.UserGeneral.PhotoUrl) ? Member.UserGeneral.PhotoUrl : "/App_Themes/mainTheme/images/noimage.png";
                    ...
                    hdnUserProfilPhotoUrl.Value = !string.IsNullOrWhiteSpace(Member.UserGeneral.PhotoUrl) ? Member.UserGeneral.PhotoUrl : string.Empty;
        ...
        public void BindHomeInfo()
        {
            try
            {
                ...
                hfEditHomeCountry.Value = Member.UserGeneral.HomeCountry != null ? Member.UserGeneral.HomeCountry.Value.ToString() : string.Empty;
                hfEditHomeCity.Value = Member.UserGeneral.HomeCity != null ? Member.UserGeneral.HomeCity.Value.ToString() : string.Empty;
                hfEditHomeTown.Value = Member.UserGeneral.HomeTown != null ? Member.UserGeneral.HomeTown.Value.ToString() : string.Empty;
        ...
        public void BindWorkInfo()
        {
            try
            {
                ...
                hfEditWorkCountry.Value = Member.UserGeneral.WorkCountry != null ? Member.UserGeneral.WorkCountry.Value.ToString() : string.Empty;
                hfEditWorkCity.Value = Member.UserGeneral.WorkCity != null ? Member.UserGeneral.WorkCity.Value.ToString() : string.Empty;
                hfEditWorkTown.Value = Member.UserGeneral.WorkTown != null ? Member.UserGeneral.WorkTown.Value.ToString() : string.Empty;
                #endregion
        ...
        public static MemberInfo BindHomeCountryCityTown(MemberInfo memberInfo, DropDownList ddlCountry, DropDownList ddlCity, DropDownList ddlTown)
        {
        ...
        public static MemberInfo BindWorkCountryCityTown(MemberInfo memberInfo, DropDownList ddlCountry, DropDownList ddlCity, DropDownList ddlTown)
        {
        ...
        {
            hfEditHomeCountry.Value = ddlEditHomeCountry.SelectedIndex > 0 ? ddlEditHomeCountry.SelectedItem.Value : string.Empty;
        ...
        {
            hfEditWorkCountry.Value = ddlEditWorkCountry.SelectedIndex > 0 ? ddlEditWorkCountry.SelectedItem.Value : string.Empty;
            ...
            if (uploadedFiles.Count > 0)
            {
                ...
                if (userPostedFile.ContentLength > 0)
                {
                    try
                    {
                        ...
                        lock (orj)
                        {
                            System.Drawing.Image i = ImageHelper.ResizeImage(orj, new Size(150, 150));
