...
public partial class M_UserControls_Rss : UserControl
{
    ...
    public List<RssItem> RssGetir(int rssId)
    {
        ...
        if (SelectedRss != null)
        {
            ...
            feeds = ReadFeeds(SelectedRss.Name, SelectedRss.Url, maxRssCount, (bool) SelectedRss.IsScroll);
        }
        return feeds;
    }

    private List<RssItem> ReadFeeds(string rssName, string rssUrl, int rssMaxCount, bool scroll)
    {
        string uri = @rssUrl;
