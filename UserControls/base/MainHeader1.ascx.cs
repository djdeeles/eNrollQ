...
public partial class UserControls_MainHeader1 : UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (oInfo.header2Path != "")
        {
            if (oInfo.header2Type == 1)
            {
                ...
                Lt.Text = string.Format("<a href='{0}'><img src='{1}' max-width='150px'></img></a>",
                    "../../Default.aspx", oInfo.header2Path.Replace("~", ""));
            ...
            if (oInfo.header2Type == 2)
            {
                ...
                olit.Text = "<object type='application/x-shockwave-flash' data='" + flashPath + "'  width='" +
                            oInfo.header2Width + "' height='" + oInfo.header2Heigth + "'" + ">" +
