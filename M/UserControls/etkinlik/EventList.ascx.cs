...
public partial class M_UserControls_EventList : UserControl
{
            ...
            foreach (Control c in control.Controls)
            {
                if (c is HyperLink)
                {
                    ...
                    if ((!string.IsNullOrEmpty(Request.Url.AbsolutePath)) && (!string.IsNullOrEmpty(Request.Url.Query)))
                    {
                        ...
                        {
                            currentLink.NavigateUrl = currentLink.NavigateUrl.Replace("/m/Events.aspx?",
                                                                                      "/m/etkinlikler-");
                        }
