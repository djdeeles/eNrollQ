...
public partial class Default : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (oLang.startupMenuId > 0)
        {
            ...
            if (systemMenu != null)
            {
                redirect = UrlMapping.LinkOlustur(oLang.startupMenuId.ToString(), systemMenu.name, "m/sayfa");
            }
            else
            {
                redirect = UrlMapping.LinkOlustur(oLang.startupMenuId.ToString(), "", "m/sayfa");
            }
