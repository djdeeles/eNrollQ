...
public partial class userControls_AlbumVideos : UserControl
{
            ...
            foreach (Control c in control.Controls)
            {
                if (c is HyperLink)
                {
                    ...
                    if ((!string.IsNullOrEmpty(Request.Url.AbsolutePath)) && (!string.IsNullOrEmpty(Request.Url.Query)))
                    {
                        ...
                        {
                            currentLink.NavigateUrl = currentLink.NavigateUrl.Replace("/AlbumVideos.aspx?",
                                                                                      "/albumvideolari-");
                        }
