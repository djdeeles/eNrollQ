...
<body style="width: 100%; background-color: #fff; background-image: none;">
    <form id="form1" runat="server" viewstatemode="Enabled">
        <asp:MultiView runat="server" ID="mvFinance" ActiveViewIndex="0">
            ...
            <asp:View runat="server" ID="vCorporationPaymentDetail">
                <table cellpadding="3" cellspacing="5" class="GridViewStyle" style="width: 250px;">
                    <th colspan="2">
                        <%=AdminResource.lbPayment %>
                    </th>
                    <tr>
                        ...
                        <td width="115px">
                            <asp:Label runat="server" ID="lbCorporationPaymentType"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationAmount"></asp:Label>
                        </td>
                    </tr> 
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationProcessUser"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationProcessDate"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b><%=AdminResource.lbDesc%></b>
                        </td>
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDesc"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:View>
            <asp:View runat="server" ID="vCorporationDuesDetail">
                <table cellpadding="3" cellspacing="5" class="GridViewStyle" style="width: 250px;">
                    <th colspan="2">
                        <%=AdminResource.lbDebiting %>
                    </th>
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDuesAmount"></asp:Label>
                        </td>
                    </tr> 
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationReceiptNo"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationReceiptDate"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDuesProcessUser"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDuesProcessDate"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <b><%=AdminResource.lbService%></b>
                        </td>
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDuesService"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbCorporationDuesDesc"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:View>
