...
namespace eNroll
{
    public partial class m_RandomField : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Request.QueryString.Count > 0)
            {
                if (HttpContext.Current.Request.QueryString["id"] != null &&
                    HttpContext.Current.Request.QueryString["title"] != null)
                {
                    try
                    {
                        ...
                        if (randomField != null)
                        {
                            ...
                            var site =
                                _entities.SiteGeneralInfo.FirstOrDefault(
                ...
                foreach (Control c in control.Controls)
                {
                    if (c is HyperLink)
                    {
                            ...
                            (!string.IsNullOrEmpty(Request.Url.Query)))
                        {
                            ...
                            {
                                currentLink.NavigateUrl = currentLink.NavigateUrl.Replace("RandomField.aspx?",
                                                                                          "sayfa-r-");
                            }
