...
public partial class UserControls_MenuSubMenul : MenuControlBase
{
    ...
    protected void ddlDynamicList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("/m/dinamik-" + ddlDynamicList.SelectedValue, false);
        }
    }
    ...
    protected void DataList1_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        ...
        myLink.PostBackUrl = "/m/dinamik-" + myLink.CommandArgument + "-" + UrlMapping.cevir(myLink.Text);
    }
}